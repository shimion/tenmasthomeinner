...
<link href="<?php bloginfo('template_directory'); ?>/styleHome.css" rel="stylesheet" type="text/css" />
	...
	<div id="mainwraper">
		<div id="wraper">
			<div id="topmain">
				...
				<div id="topright">
					<div id="information">
						<a href="<?php bloginfo('url'); ?>/contact-us">CONTACT US</a> | 877.359.5492 | <a href="<?php bloginfo('url'); ?>/wp-login.php">CLIENT LOGIN</a>
					</div>    
					<div id="navigation">
						<div id="menu" class="mhe">
